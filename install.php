...
CREATE TABLE `{$db_prefix}article` (
  ...
  `eyes` int(10) NOT NULL DEFAULT '0',
  `goodnum` int(10) NOT NULL DEFAULT '0',
  `badnum` int(10) NOT NULL DEFAULT '0',
  `saynum` int(10) NOT NULL DEFAULT '0',
  `filenum` int(10) NOT NULL DEFAULT '0',
  `getsite` varchar(255) NOT NULL DEFAULT '',
  `geturl` varchar(255) NOT NULL DEFAULT '',
  `show` int(1) NOT NULL DEFAULT '0',
  `sayok` int(1) NOT NULL DEFAULT '0',
  ...
  `copyrights` int(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
  ) {$table_charset_sql};
...
CREATE TABLE `{$db_prefix}file` (
  ...
  `addtime` varchar(12) NOT NULL DEFAULT '',
...
INSERT INTO {$db_prefix}options VALUES ('1','sitename','ideashu'),
('2','siteinfo','带你享受创意生活'),
('3','seo_title','ideashu'),
('4','seo_description','ideashu 带你享受创意生活'),
('5','seo_key','ideashu'),
('6','seo_type','1'),
('7','logo',''),
('8','siteurl','{$logurl}'),
...
CREATE TABLE `{$db_prefix}user` (
  ...
  `date` varchar(12) NOT NULL DEFAULT '',
  `lastdate` varchar(12) NOT NULL DEFAULT '',
  `sex` int(1) NOT NULL DEFAULT '0',
  `birthday` varchar(12) NOT NULL DEFAULT '',
  `diyurl` varchar(64) NOT NULL DEFAULT '',
