...
<div class="login">
	...
	<div class="<?php echo $action=='login'?'loginc':'loginc2';?>">
		...
		<div class="l_form">
			...
			<form action='' method='post' name='register' onsubmit="return yzRegister();">
				...
				<p><i class="icon icon-mail"></i><input type="text" name="sendid" id="sendid" class="form_full2" required placeholder="邮箱/手机号" /></p>
